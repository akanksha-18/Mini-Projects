...
function storeUserInfo() {
    ...
    // Prompt user for phone number until a valid one is entered
    do {
        phoneNumber = prompt("Enter your phone number (10 digits only):");
...
function isValidPhoneNumber(phoneNumber) {
    // Check if phone number contains only digits and is 10 characters long
